...
class Dashboard extends Component
{
    ...
    private function getTodayStats()
    {
        ...
        return [
            'sales' => number_format($todaySales, 2),
            'orders' => $totalOrdersToday,
            'avg_order' => number_format($avgOrderValue, 2),
    ...
    private function getCategoryBreakdownData()
    {
        ...
        foreach ($categoryData as $index => $category) {
            ...
            $labels[] = $categoryNames[$category->category] ?? ucfirst($category->category);
