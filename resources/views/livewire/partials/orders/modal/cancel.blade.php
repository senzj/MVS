@if($showCancelModal)
    <div class="fixed inset-0 z-40 flex items-center justify-center" role="dialog" aria-modal="true">
        ...
        <div class="relative bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-6 z-50 w-full max-w-md">
            <h3 class="text-lg font-semibold text-zinc-800 dark:text-zinc-100">{{ __('Confirm Cancel') }}</h3>
            ...
            <div class="mt-4 flex justify-end gap-3">
                ...
                <button type="button"
                    ...
                    <span wire:loading.remove wire:target="confirmCancel">{{ __('Yes, Cancel') }}</span>
