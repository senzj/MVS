...
>
    ...
    {{-- modal --}}
    <template x-if="show">
        <div class="fixed inset-0 z-50 overflow-y-auto bg-black/40"
            ...
            <div class="flex min-h-full items-center justify-center p-4">
                ...
                <div class="relative w-full max-w-md bg-white dark:bg-zinc-800 rounded-xl shadow-lg flex flex-col max-h-[90dvh]"
                    x-transition:enter="transition ease-out duration-200"
                    ...
                    <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-1 space-y-4">
                        ...
                        {{-- Footer --}}
                        @if($order)
                        <div class="flex items-center gap-2 justify-end px-5 py-4
                                    border-t border-zinc-100 dark:border-zinc-700 shrink-0">
                            <button type="button"
                                    x-on:click="$wire.close()"
