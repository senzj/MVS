...
<div class="w-full min-h-screen flex flex-col gap-3 overflow-x-hidden"
    ...
    <div class="w-full h-full grid grid-cols-1 lg:grid-cols-[1fr_380px] xl:grid-cols-[1fr_420px] gap-3">
        ...
        <div class="flex flex-col gap-1 min-w-0">
            {{-- Order details — MOBILE ONLY --}}
            <div class="block lg:hidden bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-100 dark:border-zinc-700 shadow-sm overflow-visible">
                @include('livewire.partials.orders.form.order.details')
            </div>
        ...
        <div class="flex flex-col gap-1 min-w-0 lg:sticky lg:overflow-y-auto scrollbar-thin scrollbar-thumb-zinc-300 dark:scrollbar-thumb-zinc-700/80 scrollbar-track-transparent">
            ...
            <div class="hidden lg:block bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-100 dark:border-zinc-700 shadow-sm overflow-visible">
                @include('livewire.partials.orders.form.order.details')
            </div>
